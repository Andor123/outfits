...
<section class="container-fluid">
    <div class="container5">
        <h1 class="h1">List of nations with New Balance outfit</h1>
        <table class="table" border="0" align="center">
            <?php
            $sql = "SELECT country_name, brand_name FROM outfit_list WHERE brand_name = 'New Balance' ORDER BY country_name ASC";
