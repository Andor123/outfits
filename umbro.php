...
<section class="container-fluid">
    <div class="container3">
        <h1 class="h1">Countries with Umbro outfit</h1>
        <table border="1" align="center" class="table">
            ...
            <tbody>
            <?php
            $sql = "SELECT country_name, sport_name, brand_name FROM outfit_list WHERE brand_name = 'Umbro' ORDER BY country_name ASC, sport_name ASC";
